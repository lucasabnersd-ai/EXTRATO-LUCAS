...
# ============================================================
REPO_DIR        = Path(r"C:\Users\lucas\Downloads\se2 - sistema\EXTRATO\extratolucas")
DEFAULT_SOURCE  = Path(r"C:\Users\lucas\Downloads\se2 - sistema\EXTRATO\espelho_conciliador.html")
REMOTE_URL      = "https://github.com/lucasabnersd-ai/extratolucas.git"
BRANCH          = "main"
PUBLISHED_NAMES = ["index.html"]
...
def publicar(source_html=None, message=None, repo_dir=None):
    ...
    print("  https://lucasabnersd-ai.github.io/extratolucas/")
